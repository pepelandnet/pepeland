...
Валюта сервера — **алмазы**.

Торговая зона разделена на тематические подзоны (ресурсы из энда, ада, инструменты, красители и тд). Игрок может иметь в каждой подзоне **до двух** бочек.

На бочках на табличке должна быть информация (пример.png)

Новые зоны могут достраиваться по надобности (обращаться к модераторам или PWGood).

Каждые две недели проходит чистка бочек, если хозяин бочки не пополнял её **2 недели**, слот освобождается и всё его содержимое уходит на склад, где подписывается и ждёт своего владельца. Изъятие содержимого из такой бочки **не** её владельцем считается **кражей**.
