...
1.1 Данный документ является официальным регламентом проекта PepeLand 5 (далее - проект), любые прочие таковыми называться не могут, но администраторы сервера (никнеймы: \_PWGood_\, DremoAVND, Rekford, Refferency, Pooshka, rilaveon, trefis, \_GWIN_\) имеют большую силу, чем правила.
