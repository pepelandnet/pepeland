...
Запрещено гриферство, [читерство](https://pepeland.club/rules/mods), воровство

Запрещено использовать в никнейме и чате запрещённые слова из [этого списка](https://pepeland.club/rules/blocklist), распространение  шок контента, а также токсичное поведение. [Подробнее](Ведёт на пункт 1.10 основных правил)

Запрещено токсичное поведение и реклама сторонних ресурсов [Подробнее](ведёт на раздел 2 основных правил)

Запрещено дюпать, но есть исключения [Список исключений](Ведёт на пункт 3.7 основных правил)

В мире построек можно строить только фермы из этого списка [Подробнее](ведёт на пункт 4)

[Подробнее про мир ферм](Ведёт на раздел 5)

[Подробнее про зоны спавна](Ведёт на раздел 6)

[Подробнее про правила торговли](Ведёт на раздел 7)

[Список разрешённых и запрещённых модов]()

[Как понять, что какая-то территория занята?](Ведёт на пункт 3.4, 3.5, 3.6)
...
7.3 Игрок может иметь только один магазин в торговой зоне. Не распространяется на команды, каждый человек из команды может иметь собственный магазин.

7.4 Открыть свой магазин вы можете в любом свободном месте в торговой зоне, если при этом постройка не будет мешать соседним магазинам. 

7.5 Запрещена постройка на территории спавна, реках, над реками и в воздухе.
